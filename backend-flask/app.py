...
cognito_jwt_token = CognitoJwtToken(user_pool_id=os.getenv("AWS_COGNITO_USER_POOL_ID"), user_pool_client_id=os.getenv("AWS_COGNITO_USER_POOL_CLIENT_ID"), region=os.getenv("AWS_DEFAULT_REGION"))
...
# Configuring Logger to Use AWS CloudWatch
...
def data_home():
  ...
  try:
    ...
    # Not sucessful Auth
    app.logger.debug("Unauthenticated - Error: ")
    app.logger.debug(e)
...
@xray_recorder.capture('activities-notifications')
