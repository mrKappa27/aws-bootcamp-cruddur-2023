...
### Backend 
We can both run our Python backend on our development environment or leverage Docker.
See [backend Dockerfile](../backend-flask/Dockerfile) as reference.
...
### Frontend 
We can both run our Node frontend on our development environment or leverage Docker.
See [frontend Dockerfile](../frontend-react-js/Dockerfile) as reference.
...
## Run Container
Useful commands for running and managing containers
...
docker logs frontend-react-js -f
```
...
See [docker-compose](../docker-compose.yml) as reference.
...
### DynamoDB Local
Useful for testing and develop locally without using the online Cloud service.
...
## Volumes
[Volumes](https://docs.docker.com/storage/volumes/) are the preferred mechanism for persisting data generated by and used by Docker containers. \
